...
>
> **Download:** [PDF version](/resources/creativity-and-machines/creativity-and-machines.pdf)
...
![The two-stroke engine of creativity — divergent generation followed by convergent evaluation. AI is superhuman on the generate stroke; contested on the evaluate stroke.](./two-stroke-engine.svg)
...
![Three value oracles and the domain split — checkable value vs. modeled current preference vs. predicted future preference.](./three-value-oracles.svg)
...
![AlphaGo Move 37 — schematic diagram of the famous shoulder hit at the 5th line. The actual game record is in Silver et al. 2016, Nature.](./alphago-move-37.svg)
...
![The transformation paradox — modeling today's audience valuation systematically suppresses tomorrow's canon.](./transformation-paradox.svg)
...
![Manet's Le Déjeuner sur l'herbe (1863) — rejected by the official Salon, exhibited at the Salon des Refusés, later canonical. Public domain (Wikimedia Commons).](./manet-dejeuner.jpg)
