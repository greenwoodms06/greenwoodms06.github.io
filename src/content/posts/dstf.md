...
![A scoring tree: an OR of (NRMSE and frequency-drift against the primary baseline) with a loose tube, plus a warn-wrapped soft-check that can flag drift but never fail the build.](./images/dstf-metrictree.svg)
